...
class ProceduresControllerTest < ActionController::TestCase
  ...
  test "should create procedure" do
    assert_difference('Procedure.count') do
      post :create, procedure: { end_date: @procedure.end_date, project_id: @procedure.project_id, start_date: @procedure.start_date, state: @procedure.state, user_id: @procedure.user_id }
    end
  ...
  test "should update procedure" do
    patch :update, id: @procedure, procedure: { end_date: @procedure.end_date, project_id: @procedure.project_id, start_date: @procedure.start_date, state: @procedure.state, user_id: @procedure.user_id }
    assert_redirected_to procedure_path(assigns(:procedure))
  end
